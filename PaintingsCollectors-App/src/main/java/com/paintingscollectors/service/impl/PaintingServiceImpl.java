...
public class PaintingServiceImpl implements PaintingService {
    ...
    @Autowired
    public PaintingServiceImpl(PaintingRepository paintingRepository, UserRepository userRepository, StyleService styleService,
    ...
    @Override
    public void paintingCreate(CreatePantingDto createPanting) {
    ...
    private Painting mapPaintingDtoToPainting(CreatePantingDto createPanting) {
        Style style = this.styleService.getStyleByStyleName(createPanting.getStyleName());
        return new Painting()
                .setName(createPanting.getName())
                .setAuthor(createPanting.getAuthor())
                .setImageUrl(createPanting.getImageUrl())
                .setStyle(style);
    }
